...
function addLatLng(event) {
  ...
  //point A
  //hard-coded as Austin State Capitol right now
  ...
  if (!pointA) {
    ...
    var contentString_A = '<h5>state capitol</h5>';
  ...
  //point B
  //hard-coded as UT Tower right now
  if (!pointB) {
 ...
 var contentString_B = "Success! You finished this level! ";
   ...
   if (google.maps.geometry.spherical.computeDistanceBetween(pointB.getPosition(), event.latLng) < 100) {
